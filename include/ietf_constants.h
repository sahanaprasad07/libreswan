...
/* size of algorithm RSASSA-PSS with SHA-256 is 67 bytes */
#define ASN1_SHA2_256_RSA_PSS_OID_SIZE 67
/* length of ASN.1 Algorithm Identifier(variable length) is 1 byte */
#define ASN1_LEN_ALGO_IDENTIFIER 1

#define ASN1_SHA2_256_ECDSA_OID_SIZE 12

/* 67 byte OID of RSASSA-PSS with SHA-256 is specified in RFC 7427 in A.4.3 */
/*static const unsigned char sha256_rsa_pss_oid_blob[ASN1_SHA2_256_RSA_PSS_OID_SIZE] = {0x30,0x46,0x06,0x09,0x2a,0x86,0x48,0x86,0xf7,0x0d,0x01,0x01,0x0a,0x30,0x39,0xa0,
...
/*static const unsigned char sha256_rsa_pss_oid_blob[ASN1_SHA2_256_RSA_PSS_OID_SIZE] = {
...
static const unsigned char sha256_ecdsa_oid_blob[ASN1_SHA2_256_ECDSA_OID_SIZE] = {
			0x30,0x0a,0x06,0x08,0x2a,0x86,0x48,0xce,0x3d,0x04,0x03,0x03};
			
//static const uint8_t len_sha256_rsa_pss_oid_blob[ASN1_LEN_ALGO_IDENTIFIER] = {ASN1_SHA2_256_RSA_PSS_OID_SIZE};
static const uint8_t len_sha256_ecdsa_oid_blob[ASN1_LEN_ALGO_IDENTIFIER] = {ASN1_SHA2_256_ECDSA_OID_SIZE};
