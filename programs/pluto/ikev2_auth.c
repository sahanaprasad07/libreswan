...
#ifdef USE_MLDSA
/* Select the ML-DSA signer matching the local key's parameter set,
 * read off SECKEYPublicKey.u.mldsa.paramSet. */
...
#ifdef USE_MLDSA
				{ &pubkey_signer_digsig_mldsa_44, (struct authby) { AUTHBY_MLDSA, }, },
				{ &pubkey_signer_digsig_mldsa_65, (struct authby) { AUTHBY_MLDSA, }, },
				{ &pubkey_signer_digsig_mldsa_87, (struct authby) { AUTHBY_MLDSA, }, },
#endif
