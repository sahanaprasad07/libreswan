...
const uint8_t asn_blob_256[ASN1_SHA2_RSA_PSS_SIZE]=RSA_PSS_SHA256_BLOB;

const struct asn_hash_blob asn_rsa_pss_sha2_256 = {
...
const uint8_t asn_blob_512[ASN1_SHA2_RSA_PSS_SIZE]=RSA_PSS_SHA512_BLOB;

const struct asn_hash_blob asn_rsa_pss_sha2_512 = {
	.hash_algo = IKEv2_AUTH_HASH_SHA2_512,
	.size = ASN1_LEN_ALGO_IDENTIFIER,
	.size_blob = size_blob_512,
	.asn_blob_len = ASN1_SHA2_RSA_PSS_SIZE,
	.asn_blob = asn_blob_512,
};
