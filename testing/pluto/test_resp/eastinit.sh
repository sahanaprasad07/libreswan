...
cp /testing/x509/strongswan_pss_256/strongEastCert.der /etc/strongswan/ipsec.d/certs/
cp /testing/x509/strongswan_pss_256/strongEastKey.der /etc/strongswan/ipsec.d/private/
