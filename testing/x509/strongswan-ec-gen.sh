...
strongswan pki --pub --in strongWestKey.der | strongswan pki --issue --cacert strongCAcert.der --cakey strongCAkey.der --dn "C=CH, O=strongSwan, CN=strongWest" --san west.testing.libreswan.org --flag ocspSigning > strongWestCert.der
strongswan pki --gen --type ecdsa --size 384 > strongEastKey.der
strongswan pki --pub --in strongEastKey.der | strongswan pki --issue --cacert strongCAcert.der --cakey strongCAkey.der --dn "C=CH, O=strongSwan, CN=strongEast" --san east.testing.libreswan.org --flag ocspSigning > strongEastCert.der
